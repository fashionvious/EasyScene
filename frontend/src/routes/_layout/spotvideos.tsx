...
async function searchHotspotVideos(
  ...
  const response = await fetch(
    "http://127.0.0.1:8000/api/v1/bilibili/hotspot-search",
    {
      method: "POST",
      headers: {
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setWeights({
                          ...weights,
                          likes: parseFloat(e.target.value) || 0,
                        })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setWeights({
                          ...weights,
                          comments: parseFloat(e.target.value) || 0,
                        })
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setWeights({
                          ...weights,
                          danmaku: parseFloat(e.target.value) || 0,
                        })
                      }
                    />
                  </div>
              ...
              <Table>
                ...
                <TableBody>
                  {searchResults.map((video) => (
                    <TableRow
                      key={video.id}
                      className={cn(selectedIds.has(video.id) && "bg-muted/50")}
                    >
                      <TableCell>
                        <Checkbox
