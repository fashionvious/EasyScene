...
# 获取第一个视频的时长
video1_duration = project.get_track_duration("main")

# 添加第二个视频，从第一个视频结束的位置开始
project.add_media_safe(video2, str(video1_duration), track_name="main")

# 在两个视频之间添加模糊转场（转场时长1秒）
project.add_transition_simple("模糊", {"start_time": video1_duration, "duration": "1s"}, "1s")
