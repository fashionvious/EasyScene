...
# 添加第一个视频
clip1 = project.add_media_safe(r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_1_20260504_063448.mp4", "0s")
print(f"clip1 type: {type(clip1)}")
print(f"clip1: {clip1}")

# 获取第一个视频的时长
track_duration = project.get_track_duration("main")
print(f"track_duration: {track_duration}")

# 添加第二个视频
clip2 = project.add_media_safe(r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_2_20260504_064703.mp4", track_duration)
print(f"clip2 type: {type(clip2)}")
