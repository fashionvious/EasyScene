...
# 添加第二个视频，从第一个视频结束处开始
project.add_media_safe(video2, str(int(duration1)) + "s")

# 获取第二个视频的时长
duration2 = project.get_track_duration("main") - duration1

# 添加转场（模糊转场，持续时间0.5秒，在两个视频之间）
transition_start = duration1 - 0.5
project.add_transition_simple("blur", transition_start, 0.5)
