...
# 获取第一个视频时长，添加第二个视频紧接其后
duration1 = project.get_track_duration("VideoMain")
...
# 在第二个视频片段上添加"模糊"转场
if seg2 is not None:
    project.add_transition_simple("模糊", video_segment=seg2, duration="0.5s")
