...
# 查看 effects 和 video_effects 结构
import json

project = JyProject("缉凶者6_7_变清晰特效v2")
...
print("=== effects ===")
print(json.dumps(materials.get('effects', []), indent=2, ensure_ascii=False))
print("\n=== video_effects ===")
ve = materials.get('video_effects', [])
print(json.dumps(ve[:2] if ve else ve, indent=2, ensure_ascii=False))