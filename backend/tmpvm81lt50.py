...
# 查看项目 draft_content.json 了解结构
project = JyProject("缉凶者6_7_变清晰特效")
video_path = "D:\\1-6 AI_Agent\\2_local_project\\EasyScene\\backend\\47d8edbd-5299-4917-be75-1f36396b156d\\generated_images\\缉凶者6_7_20260504_074658.mp4"
duration = project.add_media_safe(video_path, "0s")

# 查看当前 draft_content 结构
import json
draft_path = os.path.join(project.draft_dir, "draft_content.json")
with open(draft_path, 'r', encoding='utf-8') as f:
    content = json.load(f)

# 查看特效相关结构
print("tracks count:", len(content.get('tracks', [])))
for t in content.get('tracks', []):
    print(f"  Track type: {t.get('type')}, segments: {len(t.get('segments', []))}")
    
# 查看 materials 中是否有 effects 相关
materials = content.get('materials', {})
print("material keys:", list(materials.keys()))