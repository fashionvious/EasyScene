...
video_path = r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_3_20260503_133541.mp4"

project = JyProject("缉凶者6_3_智能粗剪", overwrite=True)

# 添加完整视频到主轨道
project.add_media_safe(video_path, "0s", track_name="MainVideo")
...
print("[+] 粗剪草稿已创建！请在剪映中打开手动裁剪精彩片段。")
print(f"    项目名: 缉凶者6_3_智能粗剪")