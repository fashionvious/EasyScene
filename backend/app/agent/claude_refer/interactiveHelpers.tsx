...
import { type ChannelEntry, getAllowedChannels, setAllowedChannels, setHasDevChannels, setSessionTrustAccepted, setStatsStore } from '../../../../../../AI资源/src/bootstrap/state.js';
import type { Command } from '../../../../../../AI资源/src/commands.js';
import { createStatsStore, type StatsStore } from '../../../../../../AI资源/src/context/stats.js';
import { getSystemContext } from '../../../../../../AI资源/src/context.js';
import { initializeTelemetryAfterTrust } from '../../../../../../AI资源/src/entrypoints/init.js';
import { isSynchronizedOutputSupported } from '../../../../../../AI资源/src/ink/terminal.js';
import type { RenderOptions, Root, TextProps } from './ink.js';
import { KeybindingSetup } from '../../../../../../AI资源/src/keybindings/KeybindingProviderSetup.js';
import { startDeferredPrefetches } from '../../../../../../AI资源/src/main.js';
import { checkGate_CACHED_OR_BLOCKING, initializeGrowthBook, resetGrowthBook } from '../../../../../../AI资源/src/services/analytics/growthbook.js';
import { isQualifiedForGrove } from '../../../../../../AI资源/src/services/api/grove.js';
import { handleMcpjsonServerApprovals } from '../../../../../../AI资源/src/services/mcpServerApproval.js';
import { AppStateProvider } from '../../../../../../AI资源/src/state/AppState.js';
import { onChangeAppState } from '../../../../../../AI资源/src/state/onChangeAppState.js';
import { normalizeApiKeyForConfig } from '../../../../../../AI资源/src/utils/authPortable.js';
import { getExternalClaudeMdIncludes, getMemoryFiles, shouldShowClaudeMdExternalIncludesWarning } from '../../../../../../AI资源/src/utils/claudemd.js';
import { checkHasTrustDialogAccepted, getCustomApiKeyStatus, getGlobalConfig, saveGlobalConfig } from '../../../../../../AI资源/src/utils/config.js';
import { updateDeepLinkTerminalPreference } from '../../../../../../AI资源/src/utils/deepLink/terminalPreference.js';
import { isEnvTruthy, isRunningOnHomespace } from '../../../../../../AI资源/src/utils/envUtils.js';
import { type FpsMetrics, FpsTracker } from '../../../../../../AI资源/src/utils/fpsTracker.js';
import { updateGithubRepoPathMapping } from '../../../../../../AI资源/src/utils/githubRepoPathMapping.js';
import { applyConfigEnvironmentVariables } from '../../../../../../AI资源/src/utils/managedEnv.js';
import type { PermissionMode } from '../../../../../../AI资源/src/utils/permissions/PermissionMode.js';
import { getBaseRenderOptions } from '../../../../../../AI资源/src/utils/renderOptions.js';
import { getSettingsWithAllErrors } from '../../../../../../AI资源/src/utils/settings/allErrors.js';
import { hasAutoModeOptIn, hasSkipDangerousModePermissionPrompt } from '../../../../../../AI资源/src/utils/settings/settings.js';
...
export async function showSetupScreens(root: Root, permissionMode: PermissionMode, allowDangerouslySkipPermissions: boolean, commands?: Command[], claudeInChrome?: boolean, devChannels?: ChannelEntry[]): Promise<boolean> {
  ...
  if (!config.theme || !config.hasCompletedOnboarding // always show onboarding at least once
    ...
    const {
      Onboarding
    } = await import('../../../../../../AI资源/src/components/Onboarding.js');
  ...
  if (!isEnvTruthy(process.env.CLAUBBIT)) {
    ...
    if (!checkHasTrustDialogAccepted()) {
      const {
        TrustDialog
      } = await import('../../../../../../AI资源/src/components/TrustDialog/TrustDialog.js');
    ...
    if (await shouldShowClaudeMdExternalIncludesWarning()) {
      ...
      } = await import('../../../../../../AI资源/src/components/ClaudeMdExternalIncludesDialog.js');
  ...
  if (process.env.ANTHROPIC_API_KEY && !isRunningOnHomespace()) {
    ...
    if (keyStatus === 'new') {
      const {
        ApproveApiKey
      } = await import('../../../../../../AI资源/src/components/ApproveApiKey.js');
  ...
  if ((permissionMode === 'bypassPermissions' || allowDangerouslySkipPermissions) && !hasSkipDangerousModePermissionPrompt()) {
    ...
    } = await import('../../../../../../AI资源/src/components/BypassPermissionsModeDialog.js');
  ...
  if (feature('TRANSCRIPT_CLASSIFIER')) {
    ...
    if (permissionMode === 'auto' && !hasAutoModeOptIn()) {
      const {
        AutoModeOptInDialog
      } = await import('../../../../../../AI资源/src/components/AutoModeOptInDialog.js');
  ...
  if (feature('KAIROS') || feature('KAIROS_CHANNELS')) {
    ...
    if (devChannels && devChannels.length > 0) {
      ...
      }] = await Promise.all([import('../../../../../../AI资源/src/services/mcp/channelAllowlist.js'), import('../../../../../../AI资源/src/utils/auth.js')]);
      ...
      if (!isChannelsEnabled() || !getClaudeAIOAuthTokens()?.accessToken) {
        ...
        const {
          DevChannelsDialog
        } = await import('../../../../../../AI资源/src/components/DevChannelsDialog.js');
  ...
  if (claudeInChrome && !getGlobalConfig().hasCompletedClaudeInChromeOnboarding) {
    ...
    } = await import('../../../../../../AI资源/src/components/ClaudeInChromeOnboarding.js');
