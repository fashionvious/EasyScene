...
# 重新创建项目，这次在同一代码块中完成所有操作
project = JyProject("缉凶者6_7_变清晰特效v3")
...
# 查看 effects 和 video_effects 
print("=== effects (count) ===")
print(len(materials.effects))
print("\n=== video_effects (count) ===")
print(len(materials.video_effects))

# 查看 tracks 中是否有 effect 类型
for track in df.tracks:
    print(f"Track type: {track.type}, attr: {track.attribute}")