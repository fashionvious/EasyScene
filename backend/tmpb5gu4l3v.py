...
# 添加第一个视频
project.add_media_safe(r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_1_20260504_063448.mp4", "0s")

# 获取第一个视频的时长（应该是整数微秒）
d1 = project.get_track_duration("main")
print(f"第一个视频时长: {d1}")

# 将微秒转为字符串格式，如 "10s"
import math
dur_seconds = int(d1 / 1000000)
start_time_str = f"{dur_seconds}s"
print(f"第二个视频起始时间: {start_time_str}")

# 添加第二个视频
project.add_media_safe(r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_2_20260504_064703.mp4", start_time_str)
