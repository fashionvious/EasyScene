...
# 查看 EffectSegment 和 VideoSceneEffectType 的详细信息
from pyJianYingDraft import EffectSegment, VideoSceneEffectType, Video_segment, SEC

# EffectSegment 构造函数
import inspect
print("=== EffectSegment ===")
print(inspect.signature(EffectSegment.__init__))
print()

# 查看类属性
print("EffectSegment attrs:", [a for a in dir(EffectSegment) if not a.startswith('_')])
print()

print("=== VideoSceneEffectType ===")
print(inspect.signature(VideoSceneEffectType.__init__))
print("VideoSceneEffectType attrs:", [a for a in dir(VideoSceneEffectType) if not a.startswith('_')])
print()

# 检查 SEC 的使用方式
print("=== SEC (Scene Effect Container?) ===")
print(type(SEC))
print("SEC value:", SEC)