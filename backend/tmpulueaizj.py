...
project = JyProject("缉凶者视频拼接")

v1 = r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_7_20260504_074658.mp4"
v2 = r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_8_20260504_080706.mp4"
v3 = r"D:\1-6 AI_Agent\2_local_project\EasyScene\backend\47d8edbd-5299-4917-be75-1f36396b156d\generated_images\缉凶者6_9_20260504_080936.mp4"

# 添加第一个视频
project.add_media_safe(v1, "0s")

# 获取第一个视频的结束时间，作为第二个视频的起始时间
t2 = project.get_track_duration("video")
print(f"视频1结束时间: {t2}")
project.add_media_safe(v2, t2)

# 获取前两个视频的总时长，作为第三个视频的起始时间
t3 = project.get_track_duration("video")
print(f"视频2结束时间: {t3}")
project.add_media_safe(v3, t3)
