...
print(f"第一个视频时长: {t1}")
# 添加第二个视频，从第一个视频结束处开始
project.add_media_safe("D:\\1-6 AI_Agent\\2_local_project\\EasyScene\\backend\\47d8edbd-5299-4917-be75-1f36396b156d\\generated_images\\缉凶者6_5_20260504_074040.mp4", t1)
# 防黑屏：必须在 save() 前调用
