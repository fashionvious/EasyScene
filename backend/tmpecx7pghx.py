...
# 添加第一个视频
project.add_media_safe("D:\\1-6 AI_Agent\\2_local_project\\EasyScene\\backend\\47d8edbd-5299-4917-be75-1f36396b156d\\generated_images\\缉凶者6_4_20260504_073607.mp4", "0s")
# 获取主轨道时长（第一个视频的时长），返回的是微秒
t1_us = project.get_track_duration("main")
# 将微秒转换为秒字符串格式
t1_sec = t1_us / 1000000.0
print(f"第一个视频时长: {t1_sec}秒")
# 添加第二个视频，从第一个视频结束处开始
project.add_media_safe("D:\\1-6 AI_Agent\\2_local_project\\EasyScene\\backend\\47d8edbd-5299-4917-be75-1f36396b156d\\generated_images\\缉凶者6_5_20260504_074040.mp4", f"{t1_sec}s")
# 防黑屏：必须在 save() 前调用
